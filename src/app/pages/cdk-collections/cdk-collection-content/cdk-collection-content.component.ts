...
@Component({
  selector: 'app-cdk-collection-content',
  templateUrl: './cdk-collection-content.component.html',
  styleUrls: ['./cdk-collection-content.component.scss']
})
export class CdkCollectionContentComponent implements OnInit {
